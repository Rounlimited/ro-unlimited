...
const REASONS = [
  { icon: Shield, title: '25+ Years Showing Up', description: '25+ years of earning trust across three states. Not because of marketing — because the work speaks for itself.' },
  { icon: Wrench, title: 'One Company. Underground Up.', description: 'We build the building AND run the utilities under it — grading, water, sewer, foundation, framing, finishes. Nothing gets handed off.' },
