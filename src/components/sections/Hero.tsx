  ...
  return (
    <div ref={spacerRef} className="relative">
      <section ref={sectionRef} className="min-h-screen flex items-center justify-start lg:justify-center overflow-hidden bg-ro-black pt-20">
        ...
        <div className="absolute inset-0 z-[2] bg-gradient-to-b from-ro-black/40 via-ro-black/24 to-ro-black/58" />
        {/* Text-area vignette — a soft neutral-grey pocket hugging the copy
            column only. Width is clamped to roughly the text measure (the copy
            is max-w-2xl) instead of a % of the viewport: a percentage ellipse
            grows with the screen and ends up greying the entire frame on
        ...
        {/* Faint grey wash — just enough matte film character across the frame.
            Kept low: the grey is meant to sit around the text, not over the
        ...
        <div className="relative z-[10] w-full max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-4 pb-4 lg:pt-8 lg:pb-8">
          ...
          <div className="text-left sm:text-center">
            ...
            <h1>
              <span ref={line1Ref} className="block text-ro-white font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight uppercase leading-[0.9] mb-4 drop-shadow-[0_2px_16px_rgba(0,0,0,0.9)]">
                We Build
              </span>
            ...
            <p ref={descRef} className="max-w-2xl sm:mx-auto text-ro-white/90 text-lg sm:text-xl font-body leading-relaxed tracking-wide mb-12 drop-shadow-[0_1px_6px_rgba(0,0,0,0.5)]">
              Commercial buildings and custom homes &mdash; built by the same company that grades the site and runs the utilities beneath them. One contractor, first cut to final walkthrough. Licensed in SC, NC &amp; GA.
            </p>
