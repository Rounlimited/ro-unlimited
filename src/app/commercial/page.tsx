        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 border border-ro-gold/20 bg-ro-gold/5 mb-6">
              ...
              <span className="text-ro-gold text-xs font-mono tracking-wider uppercase">Commercial Division</span>
            </div>
            <h1 className="text-ro-white font-heading text-5xl sm:text-6xl lg:text-7xl tracking-tight uppercase leading-[0.9] mb-6">
              Commercial Grade,<br /><span className="gradient-text-gold">Unlimited Scale</span>
            </h1>
      ...
      <section className="py-24 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-ro-white font-heading text-4xl tracking-tight uppercase">Commercial Services</h2>
