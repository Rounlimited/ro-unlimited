  ...
  return (
    <>
      ...
      {/* ════════════════════════════════════
          DASHBOARD
      ════════════════════════════════════ */}
      <div className="flex flex-col h-full px-3 py-3 gap-3 relative overflow-y-auto scrollbar-hide">
        ...
        <div data-tour="quick-actions" className="grid grid-cols-3 gap-2 relative z-10">
          ...
          <Link href="/admin/settings"
            ...
            <p className="text-[11px] font-bold text-white/50 text-center leading-tight">Settings</p>
            <div className="absolute bottom-0 left-0 right-0 h-[2px]" style={{ background: 'linear-gradient(90deg, transparent, #888, transparent)' }} />
          </Link>
        </div>
