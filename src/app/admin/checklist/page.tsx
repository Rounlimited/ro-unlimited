  ...
  const instructionConfigs: Record<string, { title: string; description: string; steps: { text: string; link?: string; copyText?: string }[] }> = {
    google_biz: {
      ...
      steps: [
        ...
        { text: 'Tap "Managers" then "Add" and type in this email:', copyText: 'rounlimitedco@gmail.com' },
    ...
    facebook: {
      ...
      steps: [
        ...
        { text: 'Search for and add this email as an Admin:', copyText: 'rounlimitedco@gmail.com' },
