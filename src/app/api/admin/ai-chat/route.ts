  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        division: { type: 'string', description: 'Division: General Construction, Roofing, Electrical, Plumbing, HVAC, Painting, Flooring, Concrete, Framing, Demolition, Landscaping, Fencing, Windows & Doors, Siding, Insulation, Drywall, Cabinet & Countertop, Tile & Stone, Other' },
        estimate_type: { type: 'string', description: 'Estimate type: new_construction, renovation, repair, addition, commercial' },
        contract_type: { type: 'string', description: 'Contract type: fixed_price, time_and_materials, cost_plus' },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        estimate_type: { type: 'string', description: 'Estimate type' },
